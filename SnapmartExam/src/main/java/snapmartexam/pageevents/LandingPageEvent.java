...
public class LandingPageEvent {
	...
	public void accessLandingPage(WebDriver driver, ExtentReporter reporter) {
		...
		element.getWebElement(driver, "XPATH", "//snack-bar-container//button/span[contains(text(), 'Force')]").click();
